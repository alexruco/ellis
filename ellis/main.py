...
def get_new_messages():
    ...
    try:
        ...
        print(f"Unprocessed emails: {len(unprocessed_emails)}")  # Debugging count

        # Step 3: Process each unprocessed email and mark as processed
        for email_data in unprocessed_emails:
            handle_incoming_email(email_data)

        # Step 4: Return the count of new emails that were successfully processed
